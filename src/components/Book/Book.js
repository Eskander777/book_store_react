    ...
    return (
        <div className={bookCss}>
            ...
            <div className={classes.Book__price}>
                <span className={classes.Book__price_val}
                >{props.book.price}</span>
                <span> ₽</span>
            </div>
            ...
            <div className={classes.Book__description_container}>
                <div className={classes.Book__description} >
                    <h3 className="Book_Book__description_title"
                    >{props.book.title}</h3>
                    <p>{props.book.description} </p>
                    <div className={classes.Book__code}
                    >Артикул: {props.book.code} </div>
                </div>
            </div>
        </div>
    )
