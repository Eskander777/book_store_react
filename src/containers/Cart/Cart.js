...
class Cart extends Component {
  render() {
    ...
    this.props.showCustomerFormState
      ? (customerForm = (
    ...
    return this.props.showCart ? (
      <div className={classes.Cart_Modal}>
        <div className={classes.Cart_Modal__content}>
          <span className={classes.Close} onClick={this.props.closeCartClick}>
            ×
          </span>
